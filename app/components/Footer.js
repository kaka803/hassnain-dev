  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-6 mt-10 flex-wrap fade-in">
        <FooterIcon icon={<FaPhone />} label="Call me" />
        <FooterIcon icon={<FaEnvelope />} label="Mail me" />
        <FooterIcon icon={<FaUserPlus />} label="Add me" />
        <FooterIcon icon={<FaSms />} label="Text me" />
        <FooterIcon icon={<FaCommentDots />} label="Chat with me" />
      </div>
    </footer>
  )
}
